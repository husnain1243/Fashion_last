...
export const icon = () => {
  return (
    <div className="icon-container rounded w-50 d-flex justify-content-between py-2 px-3 bg-light">
        {/* <Link className="header_data_a text-dark text-decoration-none" to="/facebook_" >
        ...
        <Link className="header_data_a text-dark text-decoration-none" to="https://www.instagram.com/stylenova.ai">
        ...
        {/* <Link className="header_data_a text-dark text-decoration-none" to="/twitter_">
